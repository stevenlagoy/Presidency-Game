...
class State:
    instances: List = [] # list of pointers to all class instances
...
states: List[Dict] = [ # note: this list was generated with the help of AI. There may be innaccuracies.
...
for state in states:
    State(name= state.get("name"), population= state.get("population"), largest_cities= state.get("largest_cities"), abbreviation= state.get("abbreviation"), universities= state.get("universities"))