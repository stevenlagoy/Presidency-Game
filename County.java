public class County {
    ...
    float popDens10;
    float squareMilage;
    double shapeLength, shapeArea;
    double shapeLength2, shapeArea2;

    // demographic info
    int popWhite, popBlack, popNativeIndian, popAsian, popHawaiianPacific, popHispanic, popOther, popMultiRace;
    
    // gender and age info
    int popMale, popFemale;
    int pop0005, pop0509, pop1014, pop1519, pop2024, pop2534, pop3544, pop4554, pop5564, pop6574, pop7584, pop8500;
    float medAge, medAgeM, medAgeF;
    
    // household info
    int households;
    float avgHHSize;
    int HH_1M, HH_1F;
    int MarriedHH_Child, MarriedHH_NoChild;
    int MaleHeadH_child, FemaleHeadH_child;
    int families;
    float avgFamSize;

    // housing info
    int housingUnits, vacant, ownerOccupied, renterOccupied;
    int numFarms;
    int aveFarmAcreage, cropAcreage, avgFarmSales;
